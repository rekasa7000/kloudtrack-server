...
export const getUserOrganizations = asyncHandler(async (req: Request, res: Response) => {
  ...
  return sendResponse(res, formattedOrganizations, 200, "User organizations retrieved successfully");
});
...
export const updateOrganization = asyncHandler(async (req: Request, res: Response) => {
  ...
  logger.info(`Organization ${updatedOrganization.organizationName} updated by user ID: ${req.user!.id}`);
